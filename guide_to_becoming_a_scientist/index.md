---
title: Guide to Becoming a Scientist
authors:
...
**Systems and behavioural neuroscience** asks how neurons and neural circuits produce behaviour. Researchers may work with model organisms such as mice, flies, zebrafish, or other animals. Some laboratories use experimental techniques from molecular biology and physiology, such as electrophysiology, calcium imaging, or **optogenetics**, which allows researchers to control the activity of particular neurons using light.
...
One university might have many laboratories working with mice but relatively few researchers conducting human fMRI experiments. Another might have strong neuroimaging facilities but no laboratories working with *Drosophila*. Some institutions may specialise in systems neuroscience and techniques such as optogenetics, while others may have strengths in neurophysiology, genetics, psychology, clinical neuroscience, or computational neuroscience.

Even laboratories studying similar questions can approach them very differently.

For example, one laboratory might study memory by manipulating particular neurons in mice. Another might study memory using human behavioural experiments and fMRI. A third might build computational models of how memories are stored in neural networks.
...
Genomics, electrophysiology, microscopy, behavioural experiments, and many other areas of neuroscience are also producing increasingly large and complex datasets.
...
* reading and understanding scientific code
...
* MRI or EEG research staff
* data analysts
* programmers
* data scientists
* laboratory managers

Their work might involve recruiting participants, scheduling experiments, collecting behavioural or neuroimaging data, managing clinical studies, organising datasets, analysing data, maintaining equipment, or helping a laboratory run from day to day.
...
* MRI and medical imaging technologies
* neurotechnology
...
Computational skills developed through neuroscience can be especially transferable. Someone who learns Python, statistics, machine learning, data visualisation, or scientific computing while studying the brain may later work as a **data scientist, machine learning researcher, software engineer, or computer scientist**, including in fields that have nothing to do with neuroscience.
...
* grant or funding officer at a scientific foundation or non-profit organisation
...
You might discover that you love working at a laboratory bench. You might prefer analysing datasets and writing code. You might enjoy working directly with research participants or patients. You might become fascinated by mathematics and theoretical models. You might realise that you enjoy explaining science more than conducting experiments yourself.
