...
Or perhaps you are preparing an application for a summer internship, research programme, scholarship, or research award. Writing the application forces you to explain **what you are actually interested in and why**.
...
You might eventually spend most of your time conducting experiments in a laboratory. But the data produced by those experiments still need to be organized, visualized, analysed, interpreted, and communicated.
...
> "I became interested in this question, so I read about it. I learned the skills I needed to investigate it. I analysed this open dataset, wrote the code, made these figures, and here is what I found."
...
These experiences can therefore do two things at once: **help you become a better scientist and make you a more competitive candidate** when you apply to research laboratories, internships, research programmes, awards, scholarships, and eventually graduate school.
