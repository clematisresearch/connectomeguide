---
title: Getting Your First Research Experience?
authors:
...
Where possible, particularly if you are an undergraduate hoping to work abroad, look for **formal exchange programmes, research awards, and international internship schemes**.
...
Different countries, universities, and funding agencies have their own programmes.

Do your research.

Sometimes the laboratory you are contacting may not even know about a particular programme available to *you*. If you can tell a professor, "There is an exchange programme that would fund my visit and provides a formal route for me to work at your institution," you have already removed some of the logistical uncertainty for them.

But what if no such programme exists?
...
1. **Reading scientific papers in the way we described earlier**, especially papers / topics directly related to the laboratory you want to join.
2. **Leveraging open science and developing computational skills** that allow you to work with real scientific data and tools independently.
...
And computational skills can go beyond analysing existing datasets.

For example, if you are interested in human behavioural research, you could learn how researchers program behavioural experiments using open tools such as Pavlovia:
...
This group seems interested in **whole-brain modelling**, brain network dynamics, connectomes, and the use of ideas from physics and computation to understand the brain.
