...
And at this level, I actually recommend trying to **memorize some of these basic terms**. You will encounter them again and again. Having them in your head makes everything you read afterwards much easier.
...
Let's say you are very interested in behavioural neuroscience and memory paradigms.
...
> `tetracycline-based system TetTag labelling neuron`
...
Then I might come back to the original review and try to understand the behavioural experiment illustrated in **Figure 2**, including the difference between the questions that Figure 2a and Figure 2b can answer, which the authors explain below the figure.
...
https://pubmed.ncbi.nlm.nih.gov/25308331/
...
https://tinyurl.com/discordclematis

Our co-chairs and community will be happy to answer questions and help point you towards useful papers and resources.
...
Another very useful clue is whether a paper is repeatedly cited and discussed in the expert reviews you have been reading. Tanaka et al., for example, did not appear out of nowhere. We found it because the Frankland review pointed us towards it.
...
If you are interested in systems neuroscience, and particularly in engram research, the Tanaka paper we just found would be a very good example to work towards.
...
https://pmc.ncbi.nlm.nih.gov/articles/PMC5806122/
...
1. **Start with a broad topic that genuinely interests you.**
   Memory, attention, reward, addiction, consciousness, vision ... anything is fine.

2. **Learn the basic vocabulary first.**
   A good introductory textbook can be incredibly useful. Learn the major concepts and try to remember the terms that appear repeatedly.

3. **Narrow your interest a little.**
   Maybe "memory" becomes "memory retrieval", or "addiction" becomes "maladaptive reward learning".

4. **Find a good expert review.**
   Use the review to understand the major concepts, important experiments, history of the field, and questions researchers are currently asking.

5. **Read slowly and branch out whenever you need to.**
   If you don't understand a brain region, technique, behavioural paradigm, mathematical concept, or piece of biology, go and learn about it. Then come back.

6. **Follow citations when an experiment interests you.**
   Reviews can lead you directly to important primary papers.

7. **Let your interests change as you read.**
   You might begin with rodent memory and discover that you actually care about human fMRI. You might begin with behaviour and discover that you love molecular biology. That is part of the process.

8. **Eventually, choose one influential primary paper and go very very deep.**
   Spend the time required to understand what the researchers did, why they did it, what every figure means, and what conclusions the experiments actually support.

9. **Try to explain the paper yourself.**
   If you can look at the figures and explain the study as though you had performed the experiments yourself, you have moved far beyond simply "reading" the paper.
