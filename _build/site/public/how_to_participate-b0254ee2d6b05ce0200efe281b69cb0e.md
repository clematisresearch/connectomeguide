...
Participating in Conn2026 is simple. Follow the steps below to make the most of this opportunity to explore neuroscience, connectomics, and scientific research.
...
* {doc}`../handbook/index`
* {doc}`../synapse_level_connectomics_flies/index`
* {doc}`../macroscale_connectomics_humans/index`
...
## 4. Understand the Competition Deliverables
...
## 5. Understand How Your Work Will Be Evaluated
...
## 6. Complete Your Project and Submit Your Work

Participants may engage with the competition in different ways depending on their goals.

### Participation Certificate

To receive a participation certificate, participants must successfully complete and submit work for **at least one competition track at any level**.
...
When determining eligibility for a participation certificate, we place greater emphasis on effort and engagement than on obtaining specific results or conclusions. Detailed expectations can be found in the {doc}`Selection Criteria <selection_criteria>` section.

### Award Eligibility

To be considered for awards and cash prizes, participants must:

* Complete both competition tracks:

  * Synapse-Level Connectomics (Flies)
  * Macroscale Connectomics (Humans)

* Complete at least one of the two tracks at the **Advanced Level**

For complete eligibility details, please refer to:

* {doc}`Eligibility Criteria <eligibility_criteria>`

---

We encourage participants to approach the competition with curiosity, creativity, and a willingness to learn. Whether this is your first research project or one of many, Conn2026 provides an opportunity to engage with real scientific data, learn from researchers, and contribute to exciting questions about how the brain works.
