...
- **1 video submission** via Discord, reflecting on your journey and findings for your chosen track
- **1 written report** via Google Form for your chosen track
...
- **Video submission via Discord:** either
  - **1 combined video** covering both tracks, or
  - **2 separate videos**, one for each track
...
* Long-form videos (e.g., presentation-style videos with narrated slides)
* Animated explainers
* Screen recordings demonstrating analyses or visualizations
* Research journey or reflection videos
* Any other creative format that effectively communicates your work

The focus is not on professional video production, but on clearly and effectively sharing your experience and findings.
...
Please follow the guidelines and requirements for the written report for each track AND level. 

In general, the expected word count for the introductory level is 500-1000 words. The expected word count for the advanced level is 2000-4000 words. Although there is no word limit, we recommend that you do NOT exceed 7000 words as it is essential that you communicate your results concisely. 
...
![Submission flowchart](../images/submission_flowchart_dark.png)

## Notes

- Follow the instructions in the relevant track pages for formatting and content expectations.
