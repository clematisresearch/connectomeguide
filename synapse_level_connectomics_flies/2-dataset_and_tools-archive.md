...
2. **Application Programming Interface (API):** A programming interface that allows users to query, manipulate, and analyse connectome data. See the [neuPrint API Guide](3a-neuprint_api_guide.md) and [neuPrint API Tutorial Notebook](3b-neuprint_api_guide.ipynb).
